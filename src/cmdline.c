...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ignitech_dump_file_help = gengetopt_args_info_detailed_help[21] ;
  args_info->ignitech_servo_as_iap_help = gengetopt_args_info_detailed_help[22] ;
  args_info->ignitech_sai_low_help = gengetopt_args_info_detailed_help[23] ;
  args_info->ignitech_sai_low_mv_help = gengetopt_args_info_detailed_help[24] ;
  args_info->ignitech_sai_high_help = gengetopt_args_info_detailed_help[25] ;
  args_info->ignitech_sai_high_mv_help = gengetopt_args_info_detailed_help[26] ;
