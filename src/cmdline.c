...
const char *gengetopt_args_info_usage = "Usage: EngineDataLogger [OPTION]...";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nCAN Options:",
  "      --can-id-wb2=0xXXX        CAN id of Ignitech WB-2 packets. WB-2 packets\n                                  disabled if not set",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->can_id_wb2_arg = NULL;
  args_info->can_id_wb2_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->can_id_wb2_help = gengetopt_args_info_detailed_help[29] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->can_id_wb2_arg));
  free_string_field (&(args_info->can_id_wb2_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->can_id_wb2_given)
    write_into_file(outfile, "can-id-wb2", args_info->can_id_wb2_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->can_id_wb2_given && ! args_info->can_given)
    {
      fprintf (stderr, "%s: '--can-id-wb2' option depends on option 'can'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
...
.  */
          ...
          /* CAN id of Ignitech WB-2 packets. WB-2 packets disabled if not set.  */
          else if (strcmp (long_options[option_index].name, "can-id-wb2") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->can_id_wb2_arg), 
                 &(args_info->can_id_wb2_orig), &(args_info->can_id_wb2_given),
                &(local_args_info.can_id_wb2_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "can-id-wb2", '-',
                additional_error))
              goto failure;
