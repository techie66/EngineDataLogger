...
const char *gengetopt_args_info_help[] = {
  ...
  "      --ignitech-sai-low=INT    Low kpa reading. Eg: 22",
  "      --ignitech-sai-low-mv=INT Low mv value. Eg: 171",
  "      --ignitech-sai-high=INT   High kpa reading. Eg: 102",
  "      --ignitech-sai-high-mv=INT\n                                High mv value. Eg: 4782",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->output_file_date_help = gengetopt_args_info_help[4] ;
  args_info->v_help = gengetopt_args_info_help[5] ;
  args_info->v_min = 1;
  args_info->v_max = 3;
  args_info->verbose_help = gengetopt_args_info_help[6] ;
  args_info->quiet_help = gengetopt_args_info_help[7] ;
  args_info->front_controls_help = gengetopt_args_info_help[9] ;
  args_info->ignitech_help = gengetopt_args_info_help[10] ;
  args_info->lc2_help = gengetopt_args_info_help[11] ;
  args_info->lc2_delay_help = gengetopt_args_info_help[12] ;
