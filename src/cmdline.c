...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ignitech_help = gengetopt_args_info_detailed_help[19] ;
  args_info->lc2_help = gengetopt_args_info_detailed_help[20] ;
  args_info->lc2_delay_help = gengetopt_args_info_detailed_help[21] ;
  args_info->lc2_pin_help = gengetopt_args_info_detailed_help[22] ;
  args_info->sleepy_help = gengetopt_args_info_detailed_help[23] ;
  args_info->sleepy_addr_help = gengetopt_args_info_detailed_help[24] ;
  args_info->can_help = gengetopt_args_info_detailed_help[25] ;
  args_info->ignitech_dump_file_help = gengetopt_args_info_detailed_help[27] ;
  args_info->ignitech_servo_as_iap_help = gengetopt_args_info_detailed_help[28] ;
  args_info->ignitech_sai_low_help = gengetopt_args_info_detailed_help[29] ;
  args_info->ignitech_sai_low_mv_help = gengetopt_args_info_detailed_help[30] ;
  args_info->ignitech_sai_high_help = gengetopt_args_info_detailed_help[31] ;
  args_info->ignitech_sai_high_mv_help = gengetopt_args_info_detailed_help[32] ;
  args_info->mount_offset_roll_help = gengetopt_args_info_detailed_help[34] ;
  args_info->mount_offset_pitch_help = gengetopt_args_info_detailed_help[35] ;
  args_info->roll_pitch_swap_help = gengetopt_args_info_detailed_help[36] ;
  args_info->test_mode_help = gengetopt_args_info_detailed_help[37] ;
