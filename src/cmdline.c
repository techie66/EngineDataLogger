/*
  ...
  gengetopt --func-name=cmdline_parser --conf-parser
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->v_help = gengetopt_args_info_help[4] ;
  args_info->v_min = 1;
  args_info->v_max = 3;
  args_info->verbose_help = gengetopt_args_info_help[5] ;
  args_info->quiet_help = gengetopt_args_info_help[6] ;
  args_info->front_controls_help = gengetopt_args_info_help[8] ;
  args_info->ignitech_help = gengetopt_args_info_help[9] ;
  args_info->lc2_help = gengetopt_args_info_help[10] ;
  args_info->lc2_delay_help = gengetopt_args_info_help[11] ;
  args_info->lc2_pin_help = gengetopt_args_info_help[12] ;
  args_info->sleepy_help = gengetopt_args_info_help[13] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVc:o:vqf:i:l:s:", long_options, &option_index);
