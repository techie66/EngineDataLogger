...
struct gengetopt_args_info
{
 ...
 help description.  */
  ...
  char * can_id_wc2_arg;	/**< @brief CAN id of Ignitech WC-2 packets. WC-2 packets disabled if not set.  */
  char * can_id_wc2_orig;	/**< @brief CAN id of Ignitech WC-2 packets. WC-2 packets disabled if not set original value given at command line.  */
  const char *can_id_wc2_help; /**< @brief CAN id of Ignitech WC-2 packets. WC-2 packets disabled if not set help description.  */
  ...
  unsigned int can_id_wc2_given ;	/**< @brief Whether can-id-wc2 was given.  */
